	...
	<view>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">￥{{goodprice}}</text>
			</view>
			<!-- <view class="yt-list-cell b-b">
		...
		<view class="footer">
			<view class="price-content">
				...
				<text class="price">{{goodprice}}</text>
			</view>
...
<script>
	...
	export default {
		...
		onLoad(option){
			...
			let listdata= JSON.parse(option.data);
			let opts = {
				...
				res => {
					...
					if (res.data['code'] == 0) {
						...
						let cartList = list.map(item => {
							...
							this.goodprice=this.goodprice+item.price*item.number;
							return item;
						});
