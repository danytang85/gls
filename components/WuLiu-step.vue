	...
	<view class="ali">
		...
		<view class="ali_state">
			<view class="State_Four">
				<view class="FourBox">
					<text class="line noline"></text>
					<text class="ali_top_icon" style="margin: 0 0;">发</text>
					<text class="line"></text>
				</view>
				<view class="remark">
					<text class="a14" >已发货</text>
				</view>
			</view>
			<block v-for="(item,i) in datas" :key="i">
					...
					<view class="FourBox">
						...
						<text class="line"></text>
						<text class="ali_top_icon" :class="[item.desc.includes('签收')?'isOk':'']" style="margin: 0px 0px;" v-if="Type(item.desc) == true">{{item.desc | Type}}</text>
